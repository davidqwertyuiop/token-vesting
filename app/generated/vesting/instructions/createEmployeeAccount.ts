...
export function getCreateEmployeeAccountInstructionDataEncoder(): Encoder<CreateEmployeeAccountInstructionDataArgs> {
...
export function getCreateEmployeeAccountInstructionDataDecoder(): Decoder<CreateEmployeeAccountInstructionData> {
...
export function getCreateEmployeeAccountInstructionDataCodec(): Codec<
...
> = {
  ...
  totalWithdrawn: CreateEmployeeAccountInstructionDataArgs["totalWithdrawn"];
  name: CreateEmployeeAccountInstructionDataArgs["name"];
};
    ...
    accounts.employeeAccount.value = await getProgramDerivedAddress({
      ...
      seeds: [
        getBytesEncoder().encode(
          new Uint8Array([
            101, 109, 112, 108, 121, 101, 101, 95, 118, 101, 115, 116, 105, 110,
            103,
          ]),
        ),
