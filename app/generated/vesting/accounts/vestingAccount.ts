...
/** Gets the encoder for {@link VestingAccountArgs} account data. */
...
/** Gets the decoder for {@link VestingAccount} account data. */
...
/** Gets the codec for {@link VestingAccount} account data. */
